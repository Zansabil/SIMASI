...
import { FiHome, FiList, FiShoppingCart, FiTool, FiBell, FiUser, FiUsers, FiPlus, FiTrash2, FiPrinter, FiEye, FiX, FiCheckCircle } from 'react-icons/fi';
import './PengadaanAset.css';
    ...
    <div className="dashboard-layout">
      ...
      <div className="main-wrapper">
        ...
        <main className="dashboard-body">
          ...
          {/* 4. DETAIL MODAL (OFF-CANVAS OR DIALOG) */}
