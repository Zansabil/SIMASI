...
import { FiHome, FiList, FiShoppingCart, FiTool, FiUser, FiPlus, FiCheckCircle } from 'react-icons/fi';
...
export default function PetugasPengadaanAset() {
  ...
  const [userName, setUserName] = useState('Petugas Perbaikan');
  const [userRole, setUserRole] = useState('Petugas Perbaikan');
      ...
      <aside className={`sidebar ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
        <div className="sidebar-top">
          ...
          <nav className="sidebar-menu">
            <a href="#dashboard" className="nav-link-item" onClick={(e) => { e.preventDefault(); navigate('/petugas-perbaikan/dashboard'); setIsMobileMenuOpen(false); }}>
              <FiHome className="nav-icon" /> Dashboard
            </a>
            
            <a href="#assets" className="nav-link-item" onClick={(e) => { e.preventDefault(); navigate('/petugas-perbaikan/daftar-aset'); setIsMobileMenuOpen(false); }}>
            ...
            <a href="#repair" className="nav-link-item" onClick={(e) => { e.preventDefault(); navigate('/petugas-perbaikan/perbaikan'); setIsMobileMenuOpen(false); }}>
      ...
      <div className="main-wrapper">
        <header className="dashboard-navbar">
          ...
          <div className="nav-actions">
            <NotificationBell role="petugas-perbaikan" />
            <div className="nav-profile-circle" title={userName} aria-label="Profil" style={{ cursor: 'pointer' }} onClick={() => navigate('/petugas-perbaikan/profile')}>
              <FiUser size={22} />
            </div>
          </div>
        </header>
