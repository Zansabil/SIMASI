...
export default function AdminPengadaanAset() {
  ...
  const [userName, setUserName] = useState('Admin Unit');
  const [userRole, setUserRole] = useState('Admin Unit');
      ...
      <aside className={`sidebar ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
        <div className="sidebar-top">
          ...
          <nav className="sidebar-menu">
            <a href="#dashboard" className="nav-link-item" onClick={(e) => { e.preventDefault(); navigate('/admin/dashboard'); setIsMobileMenuOpen(false); }}>
              <FiHome className="nav-icon" /> Dashboard
            </a>
            
            <a href="#assets" className="nav-link-item" onClick={(e) => { e.preventDefault(); navigate('/admin/daftar-aset'); setIsMobileMenuOpen(false); }}>
            ...
            <a href="#repair" className="nav-link-item" onClick={(e) => { e.preventDefault(); navigate('/admin/perbaikan'); setIsMobileMenuOpen(false); }}>
      ...
      <div className="main-wrapper">
        <header className="dashboard-navbar">
          ...
          <div className="nav-actions">
            ...
            <div className="nav-profile-circle" title={userName} aria-label="Profil" style={{ cursor: 'pointer' }} onClick={() => navigate('/admin/profile')}>
              <FiUser size={22} />
            </div>
          </div>
        </header>
